    ...
    var firstNames: [GermanName.Gender: [String]] {
        ...
        case .senior:
            return [
                ...
                GermanName.Gender.male: ["Hans", "Heinz", "Wolfgang", "Karl", "Wilhelm", "Walter", "Franz", "Friedrich", "Werner", "Horst", "Herbert", "Günther", "Manfred", "Gustav", "Jürgen", "Rudolf", "Helmut", "Erwin", "Siegfried", "Otto", "Reinhard", "Bernd", "Peter", "Paul", "Rainer", "Dieter", "Joachim", "Klaus", "Gerhard", "Ludwig", "Eberhard", "Edgar", "Adolf", "Arnold", "Gottfried", "Harald", "Georg", "Norbert", "Rolf", "Ferdinand", "Heinrich", "Kurt", "Willi", "Alfred", "Erich", "Anton", "Fritz", "Hermann", "Matthias", "Wilfried", "Hubert", "Egon", "Lothar", "Volker", "Axel", "Rüdiger", "Holger", "Udo", "Andreas", "Markus", "Martin", "Detlef", "Ewald", "Hans-Jürgen", "Konrad", "Otmar", "Bruno", "Oskar", "Stefan", "Theodor", "Heiko", "Armin", "Wolf", "Carsten", "Falk", "Hans-Peter", "Dietrich", "Artur", "Hans-Dieter", "Norbert-Marie", "Philipp", "Valentin", "Gregor", "Johannes", "Alwin", "Benedikt", "Matthias-Marie", "Edmund", "Ingo", "Achim", "Friedbert", "Eckhard", "Wilfried-Marie", "Sven", "Eckart", "Reto", "Lutz", "Hans-Otto", "Knut", "Rainer-Marie", "Christoph", "Torsten", "Ruprecht", "Adrian", "Arndt", "Vincent", "Elo", "Rudiger", "Hans-Werner", "Hans-Christian", "Harro", "Karl-Heinz", "August", "Theo", "Albert", "Berthold", "Lukas", "Leonhard", "Fridolin", "Sigmar", "Winfried", "Albrecht", "Herwig", "Roland", "Gero", "Wolfram", "Hanno", "Wolf-Dieter", "Jörg", "Hans-Dieter", "Falko", "Hagen", "Herwig-Marie", "Hartmut", "Friedhelm", "Kuno", "Eginhard", "Hans-Wilhelm", "Jochen", "Raimund", "Siegbert", "Götz", "Dietmar", "Otmar-Marie", "Bernhard", "Alfons", "Engelbert", "Friedwald", "Gerold", "Hans-Hermann", "Eugen", "Maximilian", "Leopold", "Dominik", "Tristan", "Franz-Josef"
],
                GermanName.Gender.diverse: AgeGroup.diverseNames
            ]
        case .elderly:

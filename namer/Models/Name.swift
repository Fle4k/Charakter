...
private let germanLastNames = [
    ...
    "Anders", "Angerer", "Arend", "Arnold", "Arnoldt", "Auer","Aal", "Aalen", "Aalmann", "Aalst", "Abeck", "Abel", "Abelen", "Abend", "Abendroth", "Aberle", "Abert", "Abicht", "Abildgaard", "Abke", "Ablasser", "Abolt", "Abraham", "Abrahams", "Abratis", "Abs", "Absmeier", "Abt", "Achenbach", "Achenbrenner", "Acher", "Achterberg", "Achterholt", "Ackermann", "Aderhold", "Aeschlimann", "Aßmann", "Abele", "Abendstern", "Achilles", "Achterkamp", "Achtnich", "Ackerbauer",
    "Ackers", "Ackermann-Bauer", "Adelmann", "Ader", "Adolphi", "Aegidius", "Aertsen", "Affeld", "Afflerbach", "Agsten",
    "Ahlers", "Ahlsen", "Ahrweiler", "Aicher", "Aiblinger", "Aistleitner", "Albus", "Alfermann", "Allgöwer", "Altmann",
    ...
    "Christian", "Claßen", "Clauß", "Conrad", "Cornelius","Cahn", "Carius", "Casper", "Cassel", "Cerny", "Clasen", "Clausen", "Clauß", "Clemenz", "Clemens", "Cloos", "Cohrs", "Collin", "Cordes", "Cornelius", "Cramer", "Cronenberg", "Cronauer", "Crone", "Curtius", "Curtze","Carstens", "Carstensen", "Caspers", "Castell", "Casten", "Castro", "Cebulla", "Cella", "Cerveny", "Chmielewski",
    "Christ", "Christiansen", "Christlieb", "Cichon", "Cieslak", "Clasenberg", "Claus", "Clausius", "Cleve", "Coenen",
    "Conen", "Conradi", "Cordsen", "Corleis", "Cornelsen", "Cornet", "Craemer", "Cremer", "Croner", "Crusius",
    ...
    "Fritz", "Fuchs", "Fuhr", "Fuhrmann", "Fabian", "Falk", "Faltermeier", "Fangmann", "Färber", "Faßbinder", "Fechner", "Fehling", "Feichtinger", "Feige", "Feiler", "Feist", "Fenske", "Fenzl", "Ferm", "Ferrari", "Feuerbach", "Feuerstein", "Fichtner", "Fiebig",
    "Fiene", "Finck", "Fink", "Finkbeiner", "Finkel", "Fischbach", "Fischerhans", "Fittkau", "Flamm", "Fleck",
    ...
    "Jünger", "Jürgens", "Junk","Jaap", "Jablonka", "Jablonski", "Jablonsky", "Jabs", "Jach", "Jachmann", "Jack", "Jacke", "Jäckel", "Jackisch", "Jäckle", "Jackmuth", "Jackowski", "Jacob", "Jacobi", "Jacobs", "Jacobsen", "Jacoby", "Jaeckel", "Jaeger", "Jaegers", "Jaekel", "Jaenke", "Jaensch", "Jaeschke", "Jäger", "Jägers","Jahnke", "Jakobi", "Janda", "Jank", "Janke", "Jankowski", "Jansen", "Janßen", "Janssens", "Jantz",
    "Janz", "Jarke", "Jarmuth", "Jarosch", "Jaroszewski", "Jaschke", "Jaskulski", "Jaspersen", "Jasper", "Jaspers",
    "Jastram", "Jastrzembski", "Jauch", "Jauernig", "Jauß", "Jaworski", "Jecht", "Jehl", "Jentzsch", "Jeschke",
    ...
    "Niebuhr", "Niehoff", "Nies", "Nießen", "Nitz", "Nolte", "Nordmann", "Nürnberger","Nabel", "Naber", "Nachbar", "Nachtigall", "Nagel", "Nagelsmann", "Nahrwold", "Nass", "Nassauer", "Nauber",
    "Naumann", "Neff", "Neher", "Neidhardt", "Neidhart", "Neis", "Neisser", "Nellen", "Nentwig", "Neubert",
    "Neubrand", "Neuburger", "Neudorf", "Neuer", "Neufeld", "Neugebauer", "Neugraber", "Neuhäuser", "Neumeier", "Neumüller", "Neuner", "Neurath", "Neusser", "Neuß", "Neuwirth", "Ney", "Nickel", "Nicklas", "Nicolai", "Niemann",
    "Nienaber", "Nierhaus", "Niering", "Nießen", "Niggemann", "Nitsche", "Noack", "Noebel", "Norden", "Nussbaum",
    ...
    "Quandt","Quaas", "Quade", "Quante", "Quast", "Queck", "Quednau", "Queißer", "Quentin", "Quente", "Querengässer",
    "Quernheim", "Quastel", "Queiß", "Quindeau", "Quinn", "Quiring", "Quitter", "Quiram", "Quasdorf", "Quenzel",
    ...
    "Tack", "Tackenberg", "Tandler", "Tannenbaum", "Tappert", "Tarnow", "Tasche", "Tast", "Teichert", "Teichmann",
    "Teige", "Temme", "Tenne", "Tesch", "Teschke", "Theilig", "Theisen", "Thiede", "Thier", "Thoma",
    "Thönes", "Thormann", "Thüring", "Thurmann", "Tiburski", "Tiede", "Tiedemann", "Tillmann", "Tobias", "Töpfer", "Tarnow", "Tasche", "Tast", "Teichert", "Teichmann", "Teige", "Temme", "Tenne", "Tesch", "Teschke",
    "Theilig", "Theisen", "Thiede", "Thier", "Thoma", "Thönes", "Tiburski", "Tiede", "Tillmann", "Tobias",
    "Uhlemann", "Ullrich", "Unruh", "Urban","Uhlemann", "Ullrich", "Unruh", "Urban", "Unger", "Unterberger", "Ullman", "Ullrich", "Urbschat", "Uschmann",
    "Uhl", "Uhlmann", "Ullrichs", "Ullrichsen", "Unverzagt", "Urfer", "Utz", "Ullrichs", "Unhold", "Unkel",
    "Unverhohlen", "Ubert", "Udris", "Uhlmer", "Ure", "Urbanek", "Urbas", "Urbanski", "Urbek", "Urfer",
    "Uschke", "Usinger", "Usunier", "Uft", "Unkelbach", "Ume", "Undrath", "Underberg", "Unterberg", "Ungermaier",
    "Unke", "Uner", "Undritz", "Uhlert", "Ungerer", "Uesch", "Ungermeier", "Ust", "Ustörm",
    "Utzberger", "Utke", "Utsche", "Ullenius", "Uscheck", "Uppenkamp", "Udermann", "Uckert", "Uffinger", "Uker",
    "Vater", "Velten", "Vieth", "Vogel", "Voges", "Vogt", "Voigt", "Voit", "Vollmer","Vahl", "Vahrenholt", "Vahrenkamp", "Vail", "Valentin", "Valerius", "Vallentin", "Vallee", "Vallerius", "Valtier","Vater", "Velten", "Vieth", "Vogel", "Voges", "Vogt", "Voigt", "Voit", "Vollmer", "Vahl",
    "Vahrenholt", "Vahrenkamp", "Vail", "Valentin", "Valerius", "Vallentin", "Vallee", "Vallerius", "Valtier",
    "Vansen", "Vanzetti", "Vare", "Varney", "Vass",
    "Vasseur", "Vaupel", "Verbeek", "Verbin", "Verderame", "Verein", "Vermunt", "Vermeulen", "Verschuren",
    "Vesely", "Vesper", "Vestra", "Vetter", "Völcker", "Voll", "Vollbrecht", "Vollmuth", "Völkl", "Vorbrüggen",
    "Vogelbacher", "Völkel", "Volkert", "Vonderharr", "Voss", "Vögtle", "Vosseler", "Viegener", "Volland", "Vondrak",
    "Vana", "Vogl", "Vockeroth", "Vailly", "Valder", "Viers", "Vizek", "Vogelsang", "Vost",
    ...
    "Wollny", "Wurster",
    "Zeiler", "Zellner", "Ziegler", "Zimmermann", "Zoller", "Zorn","Zornig", "Zwick", "Zacharias", "Zachmann", "Zagel", "Zahler", "Zallert", "Zander", "Zandt", "Zang", "Zange", "Zank", "Zant", "Zaot", "Zapalac", "Zapf", "Zapp", "Zarth", "Zastrow", "Zaun", "Zeckser", "Zedelius", "Zeemann", "Zeesink", "Zehender", "Zehler", "Zehnle", "Zeiger", "Zeilfelder", "Zeitler", "Zellmer", "Zembsch", "Zenger", "Zentgraf", "Zepter", "Zeuner", "Zeuschner", "Zeyher", "Zech", "Zeller",
    "Ziering", "Zelinski", "Zern", "Zilch", "Zinn", "Zlotnik", "Zornbacher", "Zobel", "Zolinski", "Zöllig",
]
